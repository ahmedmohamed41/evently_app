...
abstract class AppLocalizations {
  ...
  /// No description provided for @name_should_be_at_leaste_4_chars.
  ///
  /// In en, this message translates to:
  /// **'Name should be at leaste 4 chars'**
  String get name_should_be_at_leaste_4_chars;
  ...
  /// No description provided for @password_doesnt_match.
  ///
  /// In en, this message translates to:
